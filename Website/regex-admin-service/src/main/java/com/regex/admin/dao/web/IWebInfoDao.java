...
public interface IWebInfoDao{
	 ...
	 * @return
	 */
    int updateWebInfoDTO(@Param("enti") WebInfoDTO value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyWebInfoDTO(@Param("enti") WebInfoDTO value, @Param("assist") Assist assist);
}