...
public interface IProductDao{
	 ...
	 * @return
	 */
    int updateProductDTO(@Param("enti") ProductDTO value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyProductDTO(@Param("enti") ProductDTO value, @Param("assist") Assist assist);
}