...
public interface IAboutUsDao{
	 ...
	 * @return
	 */
    int updateAboutUsDTO(@Param("enti") AboutUsDTO value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyAboutUsDTO(@Param("enti") AboutUsDTO value, @Param("assist") Assist assist);
}