...
public interface INewsTypeDao{
	 ...
	 * @return
	 */
    int updateNewsTypeDTO(@Param("enti") NewsTypeDTO value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyNewsTypeDTO(@Param("enti") NewsTypeDTO value, @Param("assist") Assist assist);
}